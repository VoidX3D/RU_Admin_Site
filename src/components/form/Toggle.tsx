...
export function Toggle(props: ToggleProps) {
 ...
 <div className="h-5 w-9 rounded-full border dark:border-zinc-700 bg-white dark:bg-zinc-900 after:absolute after:left-0.5 after:top-0.5 after:h-4 after:w-4 after:rounded-full after:bg-zinc-500 after:transition-all peer-checked:border-emerald-500/50 peer-checked:bg-emerald-100 dark:bg-emerald-500/10 peer-checked:after:translate-x-4 peer-checked:after:bg-emerald-400" />
 </div>
 <div className="flex flex-1 flex-col">
 <span className="text-xs font-medium dark:text-zinc-300">{label}</span>
