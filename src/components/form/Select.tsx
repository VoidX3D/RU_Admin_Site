...
export function Select(props: SelectProps) {
 ...
 className="w-full appearance-none rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 px-3 py-2 text-xs text-zinc-900 dark:text-white outline-none focus:border-emerald-500/50">
 {placeholder && <option value="" className="text-zinc-400 dark:text-zinc-700">{placeholder}</option>}
