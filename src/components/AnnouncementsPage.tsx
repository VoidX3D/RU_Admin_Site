...
export function AnnouncementsPage() {
 ...
 <button className="rounded-lg border border-zinc-200 dark:border-zinc-800 px-3 py-1.5 text-xs font-medium text-zinc-600 dark:text-zinc-400 hover:bg-zinc-200 dark:bg-zinc-800 hover:text-zinc-900 dark:hover:text-zinc-200" onClick={() => setMode('list')}>Cancel</button>
 ...
 <MegaphoneIcon size={14} className="text-amber-600 dark:text-amber-400" />
 ...
 <div className="rounded-xl border border-zinc-200 dark:border-zinc-800/50 bg-zinc-50/50 dark:bg-zinc-900/30">
 <div className="flex items-center gap-2 border-b border-zinc-200 dark:border-zinc-800/50 px-4 py-3">
 <PlusIcon size={14} className="text-blue-600 dark:text-blue-400" />
 <h3 className="text-[11px] font-semibold uppercase tracking-wider text-zinc-600 dark:text-zinc-400">Event Details</h3>
 </div>
 <div className="p-4">
 <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
 ...
 <h3 className="text-[11px] font-semibold uppercase tracking-wider text-zinc-600 dark:text-zinc-400">Additional Information</h3>
 </div>
 <div className="p-4">
 <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
 ...
 <h3 className="text-[11px] font-semibold uppercase tracking-wider text-zinc-600 dark:text-zinc-400">Image</h3>
 </div>
 <div className="p-4">
 ...
 <p className="mt-0.5 text-xs text-zinc-400 dark:text-zinc-600">Create announcements with up to 1 image</p>
 </div>
 <div className="flex items-center gap-2">
 ...
 <MegaphoneIcon size={24} className="mx-auto text-zinc-400 dark:text-zinc-700" />
 <div className="mt-2 text-sm font-medium text-zinc-500">No announcements yet</div>
 <div className="text-xs text-zinc-400 dark:text-zinc-700">Click "New Announcement" to create one</div>
 </td>
 </tr>
 ) : (
 (() => {
 ...
 <td className="px-4 py-3">
 <span className="inline-block rounded-md bg-amber-100 dark:bg-amber-500/10 px-2 py-0.5 text-[10px] font-medium text-amber-600 dark:text-amber-400">{r.tag}</span>
 </td>
