...
export function AnnouncementsPage() {
 ...
 <div className="rounded-xl border dark:border-zinc-800/50 dark:bg-zinc-900/30">
 <div className="flex items-center gap-2 border-b dark:border-zinc-800/50 px-4 py-3">
 <PlusIcon size={14} className="dark:text-blue-400" />
 ...
 <h3 className="text-[11px] font-semibold uppercase tracking-wider dark:text-zinc-400">Additional Information</h3>
 </div>
 <div className="p-4">
 <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
 ...
 <h3 className="text-[11px] font-semibold uppercase tracking-wider dark:text-zinc-400">Image</h3>
 </div>
 <div className="p-4">
 ...
 <p className="mt-0.5 text-xs dark:text-zinc-600">Create announcements with up to 1 image</p>
 </div>
 <div className="flex items-center gap-2">
 ...
 <td className="px-4 py-3">
 <span className="inline-block rounded-md dark:bg-amber-500/10 px-2 py-0.5 text-[10px] font-medium dark:text-amber-400">{r.tag}</span>
 </td>
